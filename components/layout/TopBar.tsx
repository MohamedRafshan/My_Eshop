...
//     return (
//         <div className="sticky top-0 z-20 w-full flex justify-between items-center px-8 py-4 bg-gray-800 shadow-xl lg:hidden">
...
//                 />
//                 {dropdownMenu && (
//                     <div className="absolute top-10 right-6 flex flex-col gap-8 p-5 bg-gray-800 shadow-xl rounded-lg">
//                         {navLinks.map((link) => (
//                             <Link
//                                 href={link.url}
//                                 key={link.label}
